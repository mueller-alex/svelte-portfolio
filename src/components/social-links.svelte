...
<div
	...
	class="flex w-max max-w-full justify-between gap-2 rounded-[1.25rem] border border-white/5 bg-mueller-10 p-3 text-[28px] leading-7 shadow-lg bg-mueller-700 sm:gap-4"
/> -->
