...
<svelte:element
	...
	class:hover:scale-105={!noLink}
	class:group={!noLink}
	class="blob-1 flex min-h-[15vh] w-full flex-col justify-end rounded-3xl border-[1px] border-white/[.14] border-opacity-10 text-white shadow-md transition-all md:flex-row md:rounded-[40px]"
	class:my-12={!noMargin}
