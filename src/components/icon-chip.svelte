...
{#if color}
<div class="flex items-center p-3 w-max rounded-full" style={`background-color: ${bgColor}`}>
...
{:else}
<div class="p-3 w-max rounded-full bg-opacity-5 bg-mueller-900 dark:bg-mueller-50 dark:bg-opacity-10">
